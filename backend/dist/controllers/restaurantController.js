...
exports.createOrUpdateRestaurantReview = exports.getRestaurantMenus = exports.getTodayMenu = exports.createMenu = exports.getFollowedRestaurants = exports.getFollowStatus = exports.unfollowRestaurant = exports.followRestaurant = exports.createRestaurant = exports.getRestaurantById = exports.getRestaurants = void 0;
...
const getRestaurants = async (req, res, next) => {
    try {
        ...
        const formattedRestaurants = restaurants.map((r) => {
            ...
            const sumRatings = reviewsArr.reduce((acc, curr) => acc + curr.rating, 0);
...
const createOrUpdateRestaurantReview = async (req, res, next) => {
    try {
        const { id: restaurantId } = req.params;
...
exports.createOrUpdateRestaurantReview = createOrUpdateRestaurantReview;
